...
const watchList = [
  ...
  function getRating(watchList) {
    ...
    const sumRatings = watchList.reduce((acc, movie) => {
        if (movie.Director === "Christopher Nolan")
        {
            acc.ratingSum += parseFloat(movie.imdbRating);
            acc.numMovies += 1;
        }
        return acc;
    }, { ratingSum: 0, numMovies: 0 });
    
    let averageRating = sumRatings.ratingSum / sumRatings.numMovies;
